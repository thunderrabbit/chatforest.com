...
published: true
description: "Anthropic's official Postgres MCP server: archived, deprecated, SQL injection vulnerability, 21K weekly downloads. Ecosystem moved to Google Toolbox (13.5K stars), Postgres MCP Pro (2.4K stars). Rating: 2.5/5."
