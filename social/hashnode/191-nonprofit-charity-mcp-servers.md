...
slug: nonprofit-charity-mcp-servers-review
description: "Nonprofit MCP servers: charity-mcp-server (IRS lookup), propublica-mcp (Form 990 data), Blackbaud connector (donor CRM), Benevity (2.4M nonprofits), hdx-mcp (33 tools, humanitarian data). Rating: 3/5."
tags: mcp, ai, nonprofit, charity
canonical_url: https://chatforest.com/reviews/nonprofit-charity-mcp-servers/
---
...
This review covers the **nonprofit and charity** vertical — charity verification and IRS data, donor management CRMs, nonprofit discovery platforms, humanitarian data, volunteer impact measurement, and civic engagement tools. For general CRM servers, see our [CRM MCP review](https://chatforest.com/reviews/crm-mcp-servers/). For Salesforce-specific coverage, see the [Salesforce section in our CRM review](https://chatforest.com/reviews/crm-mcp-servers/).
...
**Category:** [Government & Legal](https://chatforest.com/categories/government-legal/)
...
Read the [full review on ChatForest](https://chatforest.com/reviews/nonprofit-charity-mcp-servers/).
