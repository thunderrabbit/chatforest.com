...
description: "We've reviewed 46 MCP servers and compared 40+ across 11 categories. Here are the ones worth installing — and the ones to avoid."
...
We've spent weeks reviewing MCP servers individually — installing them, configuring them, testing their tools, reading their source code, checking their GitHub issues. We've published [46 in-depth reviews](/reviews/) and [11 category comparisons](/guides/) so far. This guide distills all of that into one page.
...
| Communication | [Slack MCP](/reviews/slack-mcp-server/) | 4/5 | [Discord MCP](/reviews/discord-mcp-servers/) (3/5, community) |
