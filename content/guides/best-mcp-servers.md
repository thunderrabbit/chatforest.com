...
description: "We've reviewed 42 MCP servers and compared 40+ across 11 categories. Here are the ones worth installing — and the ones to avoid."
...
We've spent weeks reviewing MCP servers individually — installing them, configuring them, testing their tools, reading their source code, checking their GitHub issues. We've published [42 in-depth reviews](/reviews/) and [11 category comparisons](/guides/) so far. This guide distills all of that into one page.
...
After reviewing 42 MCP servers, a clear pattern has emerged:
...
| 4.0/5 | 20 | Filesystem, GitHub, Brave Search, Slack, Sentry, Exa, Neon, Supabase, Stripe, Linear, Todoist, Firecrawl, Tavily, Perplexity, MongoDB, AWS, Kubernetes, Terraform, Grafana, Datadog |
