...
description: "A comprehensive guide to 85+ MCP integrations for the maritime and ocean sector — covering vessel tracking and AIS data (MarineTraffic 9 stars, ShipXY 9 stars, Datalastic, Saillogger), oceanographic science (OceanMCP 8-server monorepo, NOAA tides, ERDDAP, hurricane tracking), shipping carriers (Maersk, Envia 170+ carriers, UPS, FedEx), marine weather (Open-Meteo marine, surf forecasts), naval architecture (shipbuilding specs, CAD tools), maritime compliance (sanctions screening, AML), satellite imagery (NASA, Copernicus, Sentinel Hub), industrial IoT/SCADA for vessel systems, and architecture patterns for AI-powered fleet intelligence, port optimization, and autonomous vessel operations."
content_type: "Guide"
