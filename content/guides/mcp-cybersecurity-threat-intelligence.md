...
description: "A comprehensive guide to 120+ MCP integrations for cybersecurity and threat intelligence — covering SIEM/SecOps (Google Security Operations official 458 stars with Chronicle/SOAR/GTI/SCC, Microsoft Sentinel MCP, Elastic Security, Wazuh community, Splunk community), vulnerability scanning (Nuclei 7 tools with 8000+ templates, Semgrep official, Trivy 7 tools, Snyk agent-scan 1700+ stars), threat intelligence (VirusTotal 109 stars, AlienVault OTX, ThreatFox/AbuseIPDB, fastmcp-threatintel with MITRE ATT&CK mapping), reverse engineering (GhidraMCP 8100 stars — most popular security MCP server, IDA Pro MCP, Binary Ninja MCP, radare2 32 tools), penetration testing (FuzzingLabs mcp-security-hub 500 stars with 38 servers and 300+ tools, Pentest-MCP-Server 88 tools, Burp Suite official, Metasploit), OSINT (Shodan 120 stars, Maigret username OSINT, DNStwist phishing detection, ZoomEye), Active Directory (BloodHound-MCP-AI 271 stars, RoadRecon Azure AD), incident response (Velociraptor MCP, forensic triage tools), and network security (Nmap, masscan, Illumio segmentation). The cybersecurity MCP ecosystem is one of the most active verticals with official servers from Google, PortSwigger, Semgrep, Snyk, Check Point, Elastic, and Microsoft."
content_type: "Guide"
