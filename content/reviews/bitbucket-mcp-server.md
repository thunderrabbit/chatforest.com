...
| **MCP infrastructure role** | None | None | None | [Gateway + Catalog (300+)](/reviews/docker-mcp-servers/) | None | None | None | None | None | None | None | N/A | N/A | Bidirectional (spec-to-tools, API execution) |
