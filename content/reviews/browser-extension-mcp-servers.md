...
description: "Browser extension MCP servers let AI agents control, inspect, and automate real browsers through Chrome extensions, DevTools Protocol, and Firefox integration via the Model Context Protocol."
