...
description: "Database migration and schema management MCP servers feature Prisma built-in CLI (v6.6.0+, migrate-dev/status/reset), Liquibase AI Changelog Generator (19 tools, private preview)"
