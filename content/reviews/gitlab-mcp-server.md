...
| Aspect | GitLab MCP | GitHub MCP | Bitbucket MCP | Docker MCP | Kubernetes MCP | CI/CD MCP | Azure DevOps MCP | IDE/Editor MCP | Testing/QA MCP | Monitoring MCP | Security MCP |
|--------|-----------|-----------|--------------|-----------|---------------|----------|-----------------|---------------|---------------|---------------|-------------|
...
| Official stars | N/A (built-in) | 28.2k | N/A | 132 | N/A | [71 (Jenkins), 80 (CircleCI)](/reviews/ci-cd-mcp-servers/) | N/A | N/A (built-in) | [9.8k](/reviews/testing-qa-mcp-servers/) | [2.5k (Grafana)](/reviews/monitoring-observability-mcp-servers/) | [N/A (CLI-integrated)](/reviews/security-scanning-mcp-servers/) |
