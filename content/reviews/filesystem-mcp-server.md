...
description: "Anthropic's Filesystem MCP server (81.6K parent repo stars, v2026.1.14, 14 tools) gives AI agents controlled file access with sandboxed directories, partial reads via head/tail"
