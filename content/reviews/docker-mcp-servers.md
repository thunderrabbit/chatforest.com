...
| **Infrastructure role** | None | None | None | MCP Gateway + Catalog (300+ servers) | None | [Build orchestration](/reviews/ci-cd-mcp-servers/) | None | None | None | None | None | N/A |
| **Enterprise management** | N/A | N/A | N/A | ToolHive (1.7k stars) | [Read-only + secret redaction](/reviews/kubernetes-mcp-servers/) | [Limited safety controls](/reviews/ci-cd-mcp-servers/) | N/A | N/A | [Metrics querying (PromQL, DQL, NRQL)](/reviews/monitoring-observability-mcp-servers/) | [Scan-and-fix capability](/reviews/security-scanning-mcp-servers/) | N/A | N/A |
