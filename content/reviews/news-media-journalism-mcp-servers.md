...
description: "News and media MCP servers let AI agents aggregate RSS feeds, monitor Hacker News and Product Hunt, query news APIs, transcribe podcasts, and fact-check headlines."
