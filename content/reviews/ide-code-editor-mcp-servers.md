...
| **Code analysis** | N/A | N/A | N/A | N/A | N/A | Build logs | **Full IDE inspections** | N/A | [Metrics querying (PromQL, DQL, NRQL)](/reviews/monitoring-observability-mcp-servers/) | [SAST/SCA scanning (Semgrep, Snyk, SonarQube)](/reviews/security-scanning-mcp-servers/) | N/A | N/A | N/A | 4+ (Postman, Apollo, Kong, Google/Apigee, MuleSoft) | Context (log patterns, traces, errors) | — | N/A |
| **Refactoring** | N/A | N/A | N/A | N/A | N/A | N/A | **Semantic rename (JetBrains)** | N/A | N/A | N/A | N/A | N/A | N/A | Bidirectional (spec-to-tools, API execution) | N/A | — | N/A |
| **Debug integration** | N/A | N/A | N/A | N/A | N/A | N/A | Debug sessions (VS Code) | [Browser automation](/reviews/testing-qa-mcp-servers/) | [Log analysis (Loki, Datadog, Elastic)](/reviews/monitoring-observability-mcp-servers/) | N/A | N/A | N/A | N/A | N/A | Log search/analysis + trace correlation | — | N/A |
