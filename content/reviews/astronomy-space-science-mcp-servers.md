...
description: "Astronomy and space science MCP servers let AI agents access NASA data, track satellites, query astronomical surveys, and compute celestial positions through the Model Context Protocol."
